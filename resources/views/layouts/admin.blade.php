...
<head>
    ...
    <link href="{{asset('backend/mystyle.css')}}" rel="stylesheet">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{route('dashboard.main')}}" class="logo">
            ...
            <span class="logo-lg">لوحه التحكم</span>
        </a>
...
{{--                            </li>--}}
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('categories.all')}}"><i class="fa fa-circle-o"></i>عرض الاقسام</a></li>
                        <li><a href="{{route('categories.create')}}"><i class="fa fa-circle-o"></i> اضافه قسم جديد</a></li>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-table"></i> <span>المنشورات</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-dollar"></i> <span> التسويق بالعموله</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="pages/examples/invoice.html"><i class="fa fa-circle-o"></i> عرض المسوقين </a></li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2021-2022 <a href="#">MH</a>.</strong> All rights
        reserved.
    </footer>
